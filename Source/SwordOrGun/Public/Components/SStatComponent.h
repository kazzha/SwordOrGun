...
class SWORDORGUN_API USStatComponent : public UActorComponent
{
	GENERATED_BODY()
...
private:
	UPROPERTY(VisibleInstanceOnly, BlueprintReadOnly, Category = "USSattComponent", Meta = (AllowPrivateAccess))
